...
USER_EXISTS = "You already registered."
PASSWORD_NOT_SAME = "Passwords are not the same."
ACTIVATION_CODE_IS_SENT = "Activation code is sent to your email."
ACTIVATION_CODE_SUBJECT = "Hello, it is fantasy game!"
YOU_ARE_NOT_ALLOWED_TO_CHANGE = "You cannot change these fields"
